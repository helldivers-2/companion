...
export default function FAQPage() {
  return (
    <Card className="mx-auto max-w-xl border border-primary bg-muted">
      <CardHeader>
      ...
      <CardContent>
        ...
        <div className="prose prose-neutral dark:prose-invert">
          <ul className="list-outside list-disc pl-4">
            ...
            <li>
              Each planet regens HP, usually ranging from 1.5% to 4.5% per hour,
              but has been seen as high as 20% per hour. The game master can
              change these values at any time. NOTE - defense campaign
        ...
        <div className="prose prose-neutral dark:prose-invert">
          ...
          <p>
            ...
            damage than the planet regens health, so it&apos;s constantly at
            full health. NOTE - the game master can account for this, so they
