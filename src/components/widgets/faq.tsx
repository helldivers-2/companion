...
export default function FAQ() {
  return (
    <div className="grid gap-10">
      <Container title="Helldivers War Status FAQ">
          ...
          <div className="rounded-lg bg-background p-4">
            <div className="prose prose-neutral dark:prose-invert">
              <p>
                ...
                are roughly 8-12 planets at any given time that you are allowed
                to play on, with the ultimate goal of liberating the planets and
                restoring democracy.
              </p>
            ...
            <div className="prose prose-neutral dark:prose-invert">
              <ul className="list-outside list-disc pl-4">
                ...
                <li>
                  ...
                  in liberation have been 1-2%, occuring as much as 5-10 times
                  to keep Super Earth at bay.
                </li>
              </ul>
            </div>
          </div>
          <div className="rounded-lg bg-background p-4">
            <div className="prose prose-neutral dark:prose-invert">
              ...
              <p>
                ...
                regen). So overnight, when Americans (the biggest player base)
                are sleeping, the bugs and bots take back a lot of the planet.
                See the 2nd bullet in how Liberation math works.
              </p>
              <h3 className="mb-4 mt-8 text-2xl font-medium tracking-tighter">
              ...
              <p>
                ...
                dealing less damage than the planet regens health, so it&apos;s
                constantly at full health. NOTE - the game master can account
                for this, so they aren&apos;t negatively impacting the userbase.
              </p>
              <h3 className="mb-4 mt-8 text-2xl font-medium tracking-tighter">
